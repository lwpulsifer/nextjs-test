...
const TimelineCard: React.FC<timelineCardProps> = ({
    ...
    const yearBlockClassName =
        "w-full border-link border-2 p-1.5 rounded-xl flex justify-center";

    return (
        <li
            className={
                "flex flex-col md:flex-row items-center md:items-start w-full"
            }
        >
            <div
                className={
                    "flex mb-2 md:mb-0 flex-col w-32 items-center mr-4 font-bold"
                }
            >
                <RotatingComponents
                ...
                {includeTrailingLine && (
                    <div className={"w-px h-full bg-highlight"} />
                )}
            </div>
